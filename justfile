...
unitree-mujoco:
    powershell.exe -NoProfile -c "if (Test-Path D:/Dev/repos/external/unitree_mujoco) { Write-Host 'unitree_mujoco available at D:/Dev/repos/external/unitree_mujoco' } else { Write-Host 'Clone: git clone https://github.com/unitreerobotics/unitree_mujoco D:/Dev/repos/external/unitree_mujoco' }"
