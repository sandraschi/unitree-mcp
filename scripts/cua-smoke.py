...
def nav_click_through(output_dir: str):
    ...
    for label, expected_header in nav_routes:
        try:
            idx = next((i for i, (route_label, _) in enumerate(nav_routes) if route_label == label), 0)
