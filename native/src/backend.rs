...
const BACKEND_NAME: &str = "unitree-mcp-backend.exe";
const BACKEND_PORT: u16 = 11052;
const BACKEND_TAG: &str = "unitree-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "UNITREE_MCP_PORT";
const ENV_HOST: &str = "UNITREE_MCP_HOST";
const ENV_TAURI: &str = "UNITREE_MCP_TAURI";
